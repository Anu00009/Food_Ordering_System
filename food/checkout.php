...
$order_success = false; // Track if order placed
...
if(isset($_POST['submit'])){
   ...
   if($check_cart->rowCount() > 0){
      ...
      if($address == ''){
         ...
         $order_success = true; // Show success page
      }
...
<section class="checkout">
   <div class="success-box" style="text-align:center; padding:40px; background:#f0fff0; border:2px solid #0f0; border-radius:10px;">
      <i class="fas fa-check-circle" style="font-size:50px; color:green;"></i>
      <h1>Order Placed Successfully!</h1>
      <p>Thank you for your purchase. Your order is being processed.</p>
      <a href="home.php" class="btn" style="margin-top:20px;">Go to Home</a>
   </div>
</section>
